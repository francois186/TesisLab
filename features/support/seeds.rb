...
AfterConfiguration do
  ...
  #Entregable.create(:FECHA_ENTREGA=>Date.new(2013,2,2), :NOMBRE=>"Entrega",:id=>1, :TESIS_ID=>1, :URI_DOCUMENTO=>"https://www.dropbox.com/s/1ia8e7y0jcebatk/PaperFor")
  ...
  #Profesore.create(:id => 500,:PRIMER_APELLIDO => 'apellido1', :PRIMER_NOMBRE => 'nombre1', :SEGUNDO_APELLIDO => 'apellido2', :SEGUNDO_NOMBRE => 'nombre2')
  #Estudiante.create(:CODIGO => '2345', :id => 500, :PRIMER_APELLIDO => 'apellido1', :PRIMER_NOMBRE => 'nombre1', :SEGUNDO_APELLIDO => 'apellido2', :SEGUNDO_NOMBRE => 'nombre2')
  #Tesi.create(:DESCRIPCION => 'Descripcion', :FECHA_INICIO => Date.new(2001,2,3), :id => 500, :NOMBRE => 'tesis1', :PROFESOR_ID => 500)
  #TesisEstudiante.create(:ESTUDIANTE_ID => 500, :TESIS_ID => 500)
  #Compromiso.create(:FECHA_CIERRE => Date.new(2021,2,3), :FECHA_COMPROMETIDA => Date.new(2014,2,3), :FECHA_CREACION => Date.new(2001,2,3), :id => 500, :ROL=>'profesor', :TESIS_ID => 500, :TITULO => 'Compromiso numero 1', :CONTENIDO => 'Contenido numero 1')
end
